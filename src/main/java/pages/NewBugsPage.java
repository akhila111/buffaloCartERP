...
public class NewBugsPage {
	...
	public void enterBugTitle() {
		bugName = GenerateRandomData.generateAlphaNumericString();
		bugTitle_text.sendKeys(bugName);
	}
	...
	public void enterReproducibility(String repr) {
