...
public class NewUserPage {
	...
	@FindBy(xpath = "//*[@id=\"select2-language-u5-container\"]")
	...
	public void enterEmploymentID(String id) {
		String randomid = GenerateRandomData.generateAlphaNumericString();
		employmentID_text.sendKeys(randomid);
	}
	...
	public void selectLocaleDropdownValue(String locale) {
		...
		String localeoption = "//li[contains(text(),'" + locale + "')]";
	...
	public void selectLanguageDropdownValue() {
		WebElement element = driver.findElement(By.xpath("//li[@='English']"));
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
